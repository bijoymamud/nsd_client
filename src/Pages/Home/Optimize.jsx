...
//     <h1 className='font-medium text-xl md:text-[40px]'>Sign Up for your business today</h1>
//     <button className='bg-[#871CA1] text-sm md:text-base px-5 md:px-10 py-3 rounded-[8px] mt-5'>Click Here</button>
// </div>
...
const Optimize = () => {
  ...
  return (
    <section className="bg-[#17141D]">
      <div className="bg-[#17141D] min-h-[50vh] md:min-h-screen flex flex-col justify-center items-center space-y-8 md:space-y-20 px-4 md:px-0">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 py-8 md:py-10">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-[#251727] p-6 rounded-xl shadow-lg text-center w-full max-w-sm mx-auto"
            >
              <h3 className="text-lg md:text-2xl font-bold text-white mb-4">{feature.title}</h3>
              <p className="w-14 h-14 text-3xl text-[#DF5EFF] mb-4 my-3 bg-[#342136] rounded-full flex mx-auto items-center justify-center">
                {feature.icon}
              </p>
              <p className="text-sm text-gray-400">{feature.description}</p>
        ...
        <div className="container mx-auto text-white">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-20">
            <div className="basis-full md:basis-5/12">
              <h1 className="text-2xl font-semibold md:text-[44px] leading-tight md:leading-[56px]">
                Optimize Operations <span className='font-normal'>with enhanced data</span>
              </h1>
              <p className="text-base md:text-[20px] font-thin mt-4 md:mt-5">
                Demand forecasting is crucial to the operational success of a foodservice industry, and at Brizo, we understand that. Our expertise isn't just in providing data; we offer solutions to integrate and interpret it effectively. This is where Brizo FoodMetrics comes into play, offering daily refreshed dashboards and in-depth visualizations.
              </p>
              <p className="mt-4 text-base md:text-[20px] font-thin">
                These tools empower you to make optimal decisions across the board, from procurement and inventory management to staffing and service delivery. By choosing Brizo, you're not just improving customer experiences; you're consistently elevating them and setting new industry benchmarks.
              </p>
            </div>
            <div className="basis-full md:basis-7/12 flex items-center justify-center md:justify-end">
              <img
                src="https://i.ibb.co.com/213HLsRL/Group-1686551099-2.png"
                alt="Restaurant analytics dashboard with chef reviewing data"
                className="rounded-lg shadow-xl w-full md:w-full"
              />
            </div>
          </div>
        </div>

        <div className="bg-[#17141D] min-h-[50vh] md:min-h-[90vh] flex flex-col justify-center items-center">
          <div className="container mx-auto text-white">
            <div className="flex flex-col md:flex-row-reverse justify-between gap-6 md:gap-20">
              <div className="basis-full md:basis-5/12">
                <h2 className="text-2xl md:text-[44px] leading-tight md:leading-[56px]">
                  <span className="font-bold">Take more strategic decisions</span>  <br />with real-time analytics
                </h2>
                <p className="text-base md:text-[20px] font-thin mt-5 w-full md:w-4/5">
                  The power of restaurant data analytics lies in collecting and leveraging data to make informed decisions. Our platform equips you with not just daily, but real-time updates and industry-leading refresh rates.
                </p>
                <p className="mt-4 text-base md:text-[20px] font-thin w-full md:w-4/5">
                  Through Brizo's unparalleled market coverage and verified contact information, you're not just navigating the foodservice industry landscape - you're mastering it, ensuring sustained profitability and robust partnerships.
                </p>
              </div>
              <div className="basis-full md:basis-7/12 flex items-center justify-center md:justify-start">
                <img
                  src="https://i.ibb.co.com/KjfGjs94/Group-1686551101-1.png"
                  alt="Team analyzing business data"
                  className="rounded-lg shadow-xl w-full md:w-full"
      ...
      <div className="container mx-auto text-white text-center py-10 md:py-20">
        <h1 className="font-medium text-2xl md:text-[40px] px-3 md:px-0">Sign Up for your business today</h1>
        <button className="bg-[#871CA1] text-sm md:text-base px-5 md:px-10 md:py-3 py-2 rounded-[8px] mt-5">
          Click Here
        </button>
      </div>
    </section>
