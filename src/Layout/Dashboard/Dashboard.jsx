  ...
  return (
    <div className="flex h-screen bg-[#606060]">
      ...
      <aside
        ...
        } bg-[#111014] border-r border-[#111014] shadow-gray-900 transition-all duration-500 ease-in-out shadow-lg flex flex-col justify-between`}
      >
        {/* Logo */}
        <Link to="/" className="py-10 flex items-center px-4 overflow-hidden">
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `flex items-center gap-3 px-3 py-2 text-[#CBCCD2] rounded-lg group relative transition-all duration-300 ${
                          isActive ? "bg-[#530073] shadow-sm" : "hover:bg-[#6e1691] hover:shadow-sm"
                        }`
                      }
                    >
        ...
        <Link to="/login" className="py-5">
          <button
            ...
            className="w-full flex items-center p-5 gap-3 px-3 text-[#CBCCD2]  bg-[#201C2C] transition-all duration-300 font-semibold justify-center"
          >
            <LogOut size={20} className="font-semibold"/>
